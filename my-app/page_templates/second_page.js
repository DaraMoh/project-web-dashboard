      ...
      <div className="container">
        <div className="row">
          <div className = "col-md-6">
            <div className="card">
              <h3 id="group-h3">About our Group</h3> {/* [CHANGE #7] - Change text for whatever you want */}
          ...
          <div className="col-md-6">
            <div className="row">
              <div className="col-md-12">
                <div className="card">
                  <div className="card-body">
                    <h5 className="card-title">TEST 1 TITLE</h5> {/* [CHANGE #9] - Change to title of your first test*/}
                    ...
                    <p className="card-text">TEST 1 SHORT SUMMARY.</p> {/* [CHANGE #10] - Short summary of test*/}
                      ...
                      <div className="modal-dialog" role="document">
                        <div className="modal-content">
                          <div className="modal-header">
                            <h5 className="modal-title" id="firstLearnModal">Example Modal title</h5> {/* [CHANGE #11] - Change name of Modal*/}
                            <button type="button" className="close" data-bs-dismiss="modal" aria-label="Close">
                              <span aria-hidden="true">&times;</span>
                            </button>
                          </div>
                          <div className="modal-body"> {/* [CHANGE #12] - Write longer description*/}
                            LONG DESCRIPTION
                            ...
                          </div>
                    ...
                    </div> {/* [CHANGE #13] - IF YOU DONT WANT LONG DESC, remove from line <div className="modal fade"> up to and including this line*/}
                  </div>
                </div>
              </div>
            </div>
