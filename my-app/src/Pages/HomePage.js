...
import GraphPage1 from './GraphPage1'; // route to GraphPages
    ...
    <div className="container text-center">
        ...
        <div className="collapse" style={paneStyle} id="myPane">
          <div className="d-flex">
            ...
            <div className="col-6" id="aboutGroup">
              <h3>About our Group</h3> {/* [CHANGE #7] - Change text for whatever you want */}
              <ul className="custom-list"> {/* [CHANGE #8] - If you want to keep a list, change the next 3 lines. If you want to remove it, delete lines from <ul> to </ul> and copy the code in Readme  */}
      ...
      <div className="row">
        <div className="col-md-6">
          <h1>Test 1</h1> {/* [CHANGE #9] - Recommend to keep, but you can change if you want*/}
          <div className="card">
            <div className="card-body">
              <h5 className="card-title">TEST 1 TITLE</h5> {/* [CHANGE #10] - Change to title of your first test*/}
              ...
              <p className="card-text">TEST 1 SHORT SUMMARY.</p> {/* [CHANGE #11] - Short summary of test*/}
                ...
                <div className="modal-dialog" role="document">
                  <div className="modal-content">
                    <div className="modal-header">
                      <h5 className="modal-title" id="firstLearnModal">Example title</h5> {/* [CHANGE #12] - Change name of Modal*/}
                      <button type="button" className="close" data-bs-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                      </button>
                    </div>
                    <div className="modal-body"> {/* [CHANGE #13] - Write longer description*/}
                      LONG DESCRIPTION
                      ...
                    </div>
              ...
              </div> {/* [CHANGE #14] - IF YOU DONT WANT LONG DESC, remove from line <div className="modal fade"> up to and including this line*/}
            </div>
          </div>
        </div>
        <div className="col-md-6">
          <h1>Test 2</h1>{/* [CHANGE #15] - Change if deemed necessary*/}
          <div className="card">
            <div className="card-body">
              <h5 className="card-title">TEST 2 TITLE</h5> {/* [CHANGE #16] - Write title*/}
              ...
              <p className="card-text">TEST 2 SHORT SUMMARY.</p> {/* [CHANGE #17] - Write summary of the graph*/}
              ...
              <div className="modal fade" id="secondLearnModal" tabIndex="-1" role="dialog" aria-labelledby="secondLearnModal" aria-hidden="true">
                <div className="modal-dialog" role="document">
                  <div className="modal-content">
                    <div className="modal-header">
                      <h5 className="modal-title" id="secondLearnModal">Modal title</h5> {/* [CHANGE #18] - Change name of the modal title*/}
                      <button type="button" className="close" data-bs-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                      </button>
                    </div>
                    <div className="modal-body"> {/* [CHANGE #19] - below -> change long description*/}
                      LONG DESCRIPTION
                      ...
                    </div>
                    <div className="modal-footer">
